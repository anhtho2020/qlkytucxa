...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 2, 'PHÒNG KẾ HOẠCH-TÀI CHÍNH');
   ...
   // $workSheet->setCellValueByColumnAndRow(0, 3, ' BỘ PHẬN QUẢN LÝ KÝ TÚC XÁ ');
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH PHIẾU CHI TIỀN THẾ CHẤP TỪ '.$tungay.' ĐẾN '.$denngay);
...
//    $workSheet->mergeCells('C7:D7');
    ...
    $workSheet->setCellValueByColumnAndRow(5, 7, ' NGÀY TRẢ THẾ CHẤP');
    ...
    $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.NGAYTRATHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,"
            . "a.NGAYTRATHECHAP,"
            . "b.MASV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,d.TENPHONG "
            . "from dsphieuchithechap a,sinhvien b,thechap c,phong d "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=c.ID_SINHVIEN and "
            . "c.ID_PHONG=d.ID_PHONG and (a.NGAYTRATHECHAP>='$tungay' and a.NGAYTRATHECHAP<='$denngay')";
    ...
    while($row=mysql_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+5, $tuDong, $row->NGAYTRATHECHAP);
    ...
    $workSheet->setCellValueByColumnAndRow(1, $tuDong+2, 'Phòng Kế hoạch-Tài chính');
