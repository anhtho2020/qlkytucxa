  ...
  <head>
    ...
    $link=  clsConnet::DBConnect();
        ...
        $query ="select a.ID_THUTIENDIENNUOC,a.ID_SINHVIEN,a.THANHTIEN,a.NGAYTHU,a.THANGNOP,a.NGUOITHU,"
                ...
                . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_PHONG=c.ID_PHONG ";//echo $query;
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách HSSV nộp tiền điện nước từ ngày - đến ngày</h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"xuatexcelthongkethutiendiennuoctungaydenngay\" action=\"ktx_xuatexcel_tk_sv_da_noptiendiennuoc_tn_dn.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                            echo "<td> <input type=\"text\" name=\"tungay\" id=\"tungay\" size=\"10\" maxlength=\"10\" value=\"\"> </td>";
                            echo "<td> Đến ngày: </td>";
                            echo "<td> <input type=\"text\" name=\"denngay\" id=\"denngay\" size=\"10\" maxlength=\"10\" value=\"\"> </td></br></br>";
                        echo "</tr>";
//                        echo "<tr>";
//                            echo "<td> Từ ngày: </td>";
