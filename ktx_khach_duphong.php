...
<!--               <div class="row">
               ...
               <div class="panel panel-default">-->
                    <header class="panel-heading">
                        <h2> Thêm khách đặt phòng vào danh sách  </h2>
...
{
?>
                            <button class="btn btn-info" data-toggle="modal" href="#modalupexcel"> <i class="icon-cloud-upload"> </i> Thêm khách đặt phòng</button>
<?php
}
?>                             
...
<!--                                                <div class="form-group">
                    ...
                    <div class="clearfix">
                              <div class="btn-group">
                                  <form role="form" action="ktx_danhsachkhach.php" method="post">
                                      
                                  <button type="submit" class="btn btn-info"> Xem danh sách khách đặt phòng </button>
                                </form> 
                              </div>                              
                          </div>  
...
<!--                                  <th>Tên</th>-->
                              ...
                              <tbody>
                                <?php
                                    ...
                                    {    
                                        $i=0;                    
                                        while ($row = mysql_fetch_array ($result_khach))     
                                        {   
                                            $i+=1;
