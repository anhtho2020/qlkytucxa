...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;   
        /*
        $stSQL ="select a.ID_THUTIENPHONGSINHVIEN,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.SOTHANGNOP,a.DONGIATHANG,a.MUCGIAM, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,d.TENPHONG "
                . "from thutienphongsinhvien a, sinhvien b, danhsachnoitru c,phong d "
                . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=c.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG";  
        */
        $stSQL="select a.ID_THUTIENPHONGSINHVIEN,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.SOTHANGNOP,a.DONGIATHANG,a.MUCGIAM, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,c.TENPHONG "
                . "from thutienphongsinhvienkhtc a, sinhvien b, phong c "
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2>Thống kê sinh viên nộp tiền phòng từ ngày - đến ngày </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thongketienphongsinhvientungaydenngay\" action=\"ktx_xuatexcel_thongke_sv_noptienphong_tungay_denngayKHTC.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
