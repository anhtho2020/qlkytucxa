...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH KHÁCH MƯỚN PHÒNG Ở KÝ TÚC XÁ ');
    ...
    $workSheet->setCellValueByColumnAndRow(1, 7, 'MA KHÁCH');
...
//    $workSheet->setCellValueByColumnAndRow(7, 7, 'NƠI SINH');
    ...
    $workSheet->setCellValueByColumnAndRow(8, 7, 'PHÒNG');
    $workSheet->setCellValueByColumnAndRow(9, 7, 'SỐ ĐIỆN THOẠI');
    ...
    $query="select a.NGAYNOITRU,b.ID_KHACH,b.MAKHACH,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,b.CMND,b.DIACHI,b.DIENTHOAI,"
...
//        $workSheet->setCellValueByColumnAndRow($tuCot+7, $tuDong, $row->NOISINH);
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+8, $tuDong, $row->TENPHONG);
        $workSheet->setCellValueByColumnAndRow($tuCot+9, $tuDong, $row->DIENTHOAI);
        $tuDong++; $stt++;
    }  
    ...
    $workSheet->getStyle("B".(10+$somautin).":E".(10+$somautin))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    $workSheet->getStyle("G".(10+$somautin))->getFont()->setSize(12);
