<?php
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH PHIẾU THU TIỀN THẾ CHẤP SVLT');
...
//    $workSheet->mergeCells('C7:D7');
    ...
    $query="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.NGAYINPHIEU,"
            . "b.MASV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,d.TENPHONG "
            . "from dsphieuthuthechaplt a,lienthong b,thechaplt c,phong d "
            . "where a.ID_LIENTHONG=b.ID_LIENTHONG and a.ID_LIENTHONG=c.ID_LIENTHONG and "
            . "c.ID_PHONG=d.ID_PHONG";
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+1, $tuDong, $row->ID_THECHAPLT);
    ...
    $name="dsphieuthutienthechaplt.xls";
    //header('Content-Type: application/vnd.ms-excel');
