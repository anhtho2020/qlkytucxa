...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $query="select a.ID_SINHVIEN, b.MAHSSV, b.HODEM, b.TEN, b.NGAYSINH,b.DIACHI,a.NGAYNOITRU, c.TENPHONG from danhsachnoitrum a, dshssv b, phong c where (a.ID_SINHVIEN=b.ID_DSHSSV) and (a.ID_PHONG=c.ID_PHONG)";
    ...
    $workSheet->setCellValueByColumnAndRow(1, 7, 'MAHSSV');
    ...
    $workSheet->setCellValueByColumnAndRow(6, 7, 'NGÀY NỘI TRÚ');
    $workSheet->setCellValueByColumnAndRow(7, 7, 'TÊN PHÒNG');
