...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, ' DANH SÁCH HSSV Ở KÝ TÚC XÁ VI PHẠM NỘI QUY ');
...
//    $workSheet->setCellValueByColumnAndRow(2, 7, 'HỌ TÊN');
    ...
    $workSheet->setCellValueByColumnAndRow(5, 7, 'QUÊ QUÁN');
...
//    $workSheet->setCellValueByColumnAndRow(7, 7, 'PHÒNG');
    ...
    $query ="select a.ID_SINHVIEN,a.NGAYVIPHAM,a.HINHTHUCVIPHAM, c.MASV, c.HODEM,c.TEN, c.NGAYSINH,c.CMND,c.NOISINH,e.MALOPCHUYENNGANH from viphamnoiquy a,sinhvien c, lopchuyennganh e  where   (a.ID_SINHVIEN=c.ID_SINHVIEN) and  (c.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH)";  
...
//        $workSheet->setCellValueByColumnAndRow($tuCot+9, $tuDong, $row->GHICHU);
    ...
    $name="dssinhvienviphamnoiquy.xls";
    //header('Content-Type: application/vnd.ms-excel');
