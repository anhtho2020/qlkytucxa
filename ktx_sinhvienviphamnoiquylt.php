    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_sinhvienviphamnoiquylt.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
    ...
    echo "function tht(){ "; 
      echo "if(confirm('Thông tin chính xác?')){ "; 
          ...
          //var num = $('#dshp input[type=checkbox]:checked').length;           
           ...
           echo "if(str!=\"\"){ "; 
                echo "document.themsinhvienviphamnoiquylt.submit();";  
                //echo "alert(str);"; 
...
include 'dbcon.php';
    $link=  clsConnet::DBConnect();
        ...
        for($i=0; $i<$sopt-1; $i++){
            $query="insert into viphamnoiquylt(ID_LIENTHONG,ID_PHONG, NGAYVIPHAM,HINHTHUCVIPHAM) "
...
//                        echo "</div>";
                    ...
                    echo "<div>"; 
                    echo "<div class=\"form-group\">";
                        echo "<form name=\"themsinhvienviphamnoiquylt\" action=\"ktx_sinhvienviphamnoiquylt.php\" method=\"post\">";
                        echo "<div class=\"form-group\">";
...
//                        echo "</tr>";
                        echo "<tr>";
                            ...
                            echo "<td> <input type=\"text\" name=\"ngayviphamnoiquy\" id=\"ngayviphamnoiquy\" size=\"8\" maxlength=\"8\" value=\"".$ngvipham."\" </td>";
                        echo "</tr>";
                    ...
                    ?>
                    <div>
                       <form role="form" action="ktx_danhsachsinhvienviphamnoiquylt.php" method="post">                                                   
                         <button type="submit" class="btn btn-info">Danh sách SVLT vi phạm nội quy</button>
                                            </form>         
                   </div>
                    ...
                    <div class="table-responsive">
                        ...
                        echo "<tbody>";
                            ...
                            $stSQL ="select a.ID_LIENTHONG,a.MASV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,"
                                    . "b.NGAYNOITRU,c.TENPHONG,d.MALOPLT from lienthong a,dssvltnoitru b,phong c,"
