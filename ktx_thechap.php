    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_thechap.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
...
echo "</script>";
    ...
    $link=  clsConnet::DBConnect();
        ...
        for($i=0; $i<$sopt-1; $i++){
            $query="insert into thechap (ID_SINHVIEN,ID_PHONG,NGAYTHECHAP,SOTIEN,HOCKY,NAMHOC,NGUOITHU ) "
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                        echo "<div>"; 
                        echo "<form name=\"dangkythechap\" action=\"ktx_thechap.php\" method=\"post\">";
                        ...
                        echo "<div>"; 
                        echo "<form name=\"xuatphiethuthechap\" action=\"ktx_danhsachthechap.php\" method=\"post\">";
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $stSQL ="select a.ID_SINHVIEN,a.MASV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,"
                                    . "b.NGAYNOITRU,c.ID_PHONG,c.TENPHONG,d.MALOPCHUYENNGANH from sinhvien a,"
                                    . "danhsachnoitru b,phong c,lopchuyennganh d  where a.ID_SINHVIEN =b.ID_SINHVIEN and "
                                    . "b.ID_PHONG=c.ID_PHONG and a.ID_LOPCHUYENNGANH=d.ID_LOPCHUYENNGANH and c.ID_PHONG=$idphong and "
                                    . "a.ID_SINHVIEN not in (select ID_SINHVIEN from thechap "
                                    . "where ID_SINHVIEN is not null)";// from danhsachnoitru where ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
                            //echo $stSQL;
