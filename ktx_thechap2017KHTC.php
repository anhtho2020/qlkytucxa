...
echo "</script>";
    ...
    $link=  clsConnet::DBConnect();
        ...
        for($i=0; $i<$sopt-1; $i++){
            $query="insert into thechap2017khtc (ID_SINHVIEN,NGAYTHECHAP,SOTIEN,NGUOITHU,ID_PHONG) "
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
							...
							." where a.ID_DSHSSV =b.ID_SINHVIEN and b.ID_PHONG=c.ID_PHONG and c.ID_PHONG=$idphong and a.ID_DSHSSV not in (select ID_SINHVIEN from thechap2017khtc where ID_SINHVIEN is not null)";// from danhsachnoitru where ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
                            //echo $stSQL;
