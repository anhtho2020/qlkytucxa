...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $idthutiendiennuoc=$_GET["idthutiendiennuoc"];
    
    $now = getdate(); 
    $ngayinphieu=$now["year"].'-'.$now["mon"].'-'.$now["mday"] ;
    
    $query_kt ="select * from dsphieuthutiendiennuoc where ID_THUTIENDIENNUOC=$idthutiendiennuoc";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_PHONG,a.ID_THUTIENDIENNUOC,a.GIADIEN,a.CSDIENCU,a.CSDIENMOI,"
            . "a.GIANUOC,a.CSNUOCCU,CSNUOCMOI,a.THANGNOP,a.THANHTIEN,a.NGAYTHU,a.NGUOITHU,"
            . "b.ID_SINHVIEN,b.MASV,b.HODEM,b.TEN,"
            . "c.TENPHONG from thutiendiennuoc a,sinhvien b,phong c,lopchuyennganh d "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_PHONG=c.ID_PHONG and "
            . "a.ID_THUTIENDIENNUOC=$idthutiendiennuoc";  
    //echo $query;
    $result=mysql_query($query, $connect);
    $somautin=  mysql_num_rows($result);
    
    $query_ins ="select a.ID_PHONG,a.ID_THUTIENDIENNUOC,a.GIADIEN,a.CSDIENCU,a.CSDIENMOI,"
            . "a.GIANUOC,a.CSNUOCCU,CSNUOCMOI,a.THANGNOP,a.THANHTIEN,a.NGAYTHU,a.NGUOITHU,b.ID_SINHVIEN,b.MASV,b.HODEM,b.TEN,"
            . "c.TENPHONG from thutiendiennuoc a,sinhvien b,phong c,lopchuyennganh d "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_PHONG=c.ID_PHONG and "
            . "a.ID_THUTIENDIENNUOC='".$idthutiendiennuoc."'";  
    //echo $query_ins;
...
//    $ngayinphieu_insert=$row_insert["NGAYINPHIEU"];
    ...
    $query_insert="insert into dsphieuthutiendiennuoc (ID_THUTIENDIENNUOC,ID_SINHVIEN,ID_PHONG,GIADIEN,CSDIENCU ,CSDIENMOI,"
            . "GIANUOC,CSNUOCCU,CSNUOCMOI,THANHTIEN, NGAYTHU,NGAYINPHIEU,THANGNOP,NGUOITHU) "
            . "Values($idthutiendiennuoc,$idlt_insert,$idphong_insert,$giadien_insert,$csdiencu_insert,$csdienmoi_insert,"
    ...
    while($row=mysql_fetch_object($result)){
        $workSheet->setCellValueByColumnAndRow(6, 5, $row->ID_THUTIENDIENNUOC);
...
//        $workSheet->setCellValueByColumnAndRow(7, $tuDong, $tongsotien);
    ...
    echo "</script>";
    echo "<a  href=\"ktx_danhsachphongdanoptiendiennuoc.php\"> Tiep tuc </a>";
}
