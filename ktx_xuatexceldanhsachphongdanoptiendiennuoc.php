...
//    $workSheet->mergeCells('C7:D7');
    ...
    $query ="select a.ID_THUTIENDIENNUOC,a.ID_SINHVIEN,a.ID_PHONG,a.GIADIEN,a.CSDIENCU ,a.CSDIENMOI,"
            . "a.GIANUOC,a.CSNUOCCU,a.CSNUOCMOI,a.THANHTIEN, a.NGAYTHU,a.NGAYINPHIEU,a.THANGNOP,a.NGUOITHU, "
            . "b.TENPHONG from dsphieuthutiendiennuoc a, phong b where a.ID_PHONG=b.ID_PHONG";
