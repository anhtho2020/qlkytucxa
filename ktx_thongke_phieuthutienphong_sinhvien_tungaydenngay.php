...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;       
        /*
        $stSQL ="select a.ID_THUTIENPHONGSINHVIEN,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.NGAYINPHIEU,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,d.TENPHONG "
                . "from dsphieuthutienphongsinhvien a, sinhvien b,danhsachnoitru c, phong d "
                . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=c.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG ORDER BY a.ID_THUTIENPHONGSINHVIEN ASC"; 
        */
        $stSQL ="select a.ID_THUTIENPHONGSINHVIEN,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.NGAYINPHIEU,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,a.TENPHONG "
                . "from dsphieuthutienphongsinhvien a , sinhvien b "
                . "where a.ID_SINHVIEN=b.ID_SINHVIEN  ORDER BY a.ID_THUTIENPHONGSINHVIEN ASC";  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2>Thống kê phiếu thu tiền phòng từ ngày - đến ngày </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thongkephieuthutienphongsinhvientungaydenngay\" action=\"ktx_xuatexcel_thongke_phieuthutienphong_sv_tungaydenngay.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                        ...
                        echo "</tr>";
                        echo "<button type=\"submit\" class=\"btn btn-info\"> In bảng kê ra excel </button>";
                        echo "</form>";   
                        echo "</div>"; 
                       ?>
                    <!--
                    ...
                    <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                                ...
                                <td width="12%">NGÀY IN PHIẾU</td>
                                <td width="6%">HỌC KỲ</td>
                                <td width="15%">NĂM HỌC</td>
                                <td width="15%">NGƯỜI THU</td>
                                <th width="3%">SỐ PHIẾU</th>
                                <?php
