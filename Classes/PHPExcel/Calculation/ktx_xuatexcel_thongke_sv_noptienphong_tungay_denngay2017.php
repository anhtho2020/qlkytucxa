...
//    
    ...
    $query="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN, b.MAHSSV, b.HODEM, b.TEN, b.NGAYSINH,a.THANHTIEN,a.NGAYTHU,a.HOCKY,a.NAMHOC,"
            . "a.NGUOITHU,d.TENPHONG from thutienphongsinhvien2017 a, dshssv b, danhsachnoitrum c, phong d "
            . " where (a.ID_SINHVIEN=b.ID_DSHSSV) and a.ID_SINHVIEN=c.ID_SINHVIEN and  c.ID_PHONG=d.ID_PHONG and "
...
//        $workSheet->setCellValueByColumnAndRow($tuCot+7, $tuDong, $row->SOTHANG);
       //$workSheet->setCellValueByColumnAndRow($tuCot+8, $tuDong, $row->TENPHONG);
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+9, $tuDong, ' ');
    ...
    $workSheet->mergeCells("E".(11+$somautin).":J".(11+$somautin));
    $workSheet->getStyle("E".(11+$somautin).":J".(11+$somautin))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
