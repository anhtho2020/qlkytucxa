...
/*    
    $query_kt ="select * from dsphieuthutienphongsinhvien2017 where ID_THUTIENPHONGSINHVIEN=$idthutienphongsinhvien";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.THANHTIEN,b.ID_DSHSSV,b.MAHSSV,b.HODEM,b.TEN,c.TENPHONG "
            . "from thutienphongsinhvien2017 a,dshssv b,phong c,danhsachnoitrum d "
            . "where a.ID_SINHVIEN=b.ID_DSHSSV and a.ID_SINHVIEN=d.ID_SINHVIEN and d.ID_PHONG=c.ID_PHONG and "
            . "a.ID_THUTIENPHONGSINHVIEN='".$idthutienphongsinhvien."'";  
    //echo $query;
    $result=mysqli_query($connect,$query);
    $somautin=  mysqli_num_rows($result);
/*    
$query_ins ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.THANHTIEN,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,"
        . "b.ID_DSHSSV,b.MAHSSV,b.HODEM,b.TEN,c.TENPHONG "
            . "from thutienphongsinhvien2017 a,dshssv b,phong c,danhsachnoitru d "
            . "where a.ID_SINHVIEN=b.ID_DSHSSV and a.ID_SINHVIEN=d.ID_SINHVIEN and d.ID_PHONG=c.ID_PHONG and "
            . "a.ID_THUTIENPHONGSINHVIEN='".$idthutienphongsinhvien."'";  
    //echo $query;
...
*/    
     ...
     */
     /*
    $query_insert="insert into dsphieuthutienphongsinhvien2017(ID_THUTIENPHONGSINHVIEN,ID_SINHVIEN,THANHTIEN,NGAYTHU,NGAYINPHIEU,"
            . "HOCKY,NAMHOC,NGUOITHU) "
            . "Values($idthutienphongsinhvien,$idlt_insert,$thanhtien_insert,'$ngaythu_insert','$ngayinphieu',"
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
        ...
        $workSheet->setCellValueByColumnAndRow(1,11, number_format($row->THANHTIEN));
...
//        $workSheet->setCellValueByColumnAndRow(7, $tuDong, $tongsotien);
 ...
 /*
    ...
    echo "</script>";
    echo "<a  href=\"ktx_danhsachsinhviennoptienphong2017.php\"> Tiep tuc </a>";
}
 */   
