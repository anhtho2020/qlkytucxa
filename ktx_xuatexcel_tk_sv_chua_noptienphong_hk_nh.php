...
//    $workSheet->setCellValueByColumnAndRow(0, 6, 'Từ ngày '.$tungay.' đến ngày '.$denngay);
    ...
    $query ="select b.ID_SINHVIEN,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,c.TENPHONG,LEFT(c.TENPHONG,1) as DAY,"
            . "e.MALOPCHUYENNGANH from sinhvien b, phong c, danhsachnoitru d, lopchuyennganh e "
            . "where d.ID_SINHVIEN=b.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG and "
            . "e.ID_LOPCHUYENNGANH=b.ID_LOPCHUYENNGANH and "
            . " b.ID_SINHVIEN not in (select ID_SINHVIEN from thutienphongsinhvien where HOCKY='$hocky' and NAMHOC='$namhoc' and ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
    //echo $query;
