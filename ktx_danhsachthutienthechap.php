          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> DANH SÁCH THU TIỀN THẾ CHẤP </h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    echo "<div class=\"form-group\">";    
                        echo "<form name=\"xuatdanhsachphiethuthechap\" action=\"ktx_xuatexceldanhsachthutienthechap.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,"
                                    . "a.NAMHOC,a.NGUOITHU,b.MASV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH, "
                                    . "c.TENPHONG from thechap a,sinhvien b,phong c "
