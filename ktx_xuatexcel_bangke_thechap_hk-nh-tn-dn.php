...
//        else echo " ";
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'BẢNG KÊ THU TIỀN THẾ CHẤP TÀI SẢN KTX HỌC KỲ '.$hocky.' NĂM HỌC '.$namhoc);
    ...
    $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,"
            . "c.TENPHONG,LEFT(c.TENPHONG,1) as DAY, e.MALOPCHUYENNGANH from thechap a,sinhvien b, phong c, danhsachnoitru d, lopchuyennganh e "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and d.ID_SINHVIEN=a.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG "
            . "and e.ID_LOPCHUYENNGANH=b.ID_LOPCHUYENNGANH "
            . "and a.NGAYTHECHAP >='$tungay' and a.NGAYTHECHAP <='$denngay' and a.HOCKY='$hocky' and a.NAMHOC='$namhoc'";//echo $query;
...
//    $workSheet->getColumnDimension('J')->setAutoSize(true);
    while($row=mysql_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+7, $tuDong, $row->SOTIEN);
    ...
    $name="bangkethutienthechaptungaydenngay.xls";
    //header('Content-Type: application/vnd.ms-excel');
