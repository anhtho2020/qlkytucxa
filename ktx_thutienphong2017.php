    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_thutienphong2017.php?idday="+idday+"&idphong="+idphong+"&hocky="+hocky+"&dcs="+dcs;
                window.location=url;
            }
...
//        echo $idphong;
        ...
        //$nguoithu==$_SESSION["hodem"]." ".$_SESSION["ten"];
        $sothang=0;
        ...
        for($i=0; $i<$sopt-1; $i++)
        {
            $query_dk="select * from thutienphongsinhvien2017 ";//echo $query_dk;
            ...
            if($kt>=1)
            {
                ...
                $query_dcs="select * from dshssv where ID_DSHSSV=$arr[$i]";//echo $query_dk;
                ...
                if($_SESSION['idqt']==2051)
				{
					...
					$query="insert into thutienphongsinhvien2017khtc(ID_SINHVIEN,SOTHANGNOP,DONGIATHANG,MUCGIAM,THANHTIEN,NGAYTHU,HOCKY,NAMHOC,NGUOITHU,ID_PHONG,GHICHU,ID_GIAOVIEN) "
                               . "values($arr[$i],$sothang,$dongiathang,'$mg',$st,'$ngaythu','$hocky','$namhoc','$nguoithu',$idphong,'$gh',$idgiaovien)";
                       mysqli_query($link,$query);
				}
                else
				{
					$idgiaovien=$_SESSION['idqt'];
					$query="insert into thutienphongsinhvien2017(ID_SINHVIEN,SOTHANGNOP,DONGIATHANG,MUCGIAM,THANHTIEN,NGAYTHU,HOCKY,NAMHOC,NGUOITHU,ID_PHONG,GHICHU,ID_GIAOVIEN) "
                               . "values($arr[$i],$sothang,$dongiathang,'$mg',$st,'$ngaythu','$hocky','$namhoc','$nguoithu',$idphong,'$gh',$idgiaovien)";
                       mysqli_query($link,$query);
				}
                //echo $query;       
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> THU TIỀN PHÒNG HSSV NỘI TRÚ TỪ KHÓA 2017 </h2>
                   ...
                   <div class="panel-body">                   		                       
                       ...
                       <?php
                        ...
                        echo "<div>"; 
                        echo "<form name=\"thutienphong\" action=\"ktx_thutienphong2017.php\" method=\"post\">";
                       ...
                       echo "</tr>";
                        ...
                        $namtruoc=$now["year"]-1;
                            ...
                            echo "<td> Năm học: </td>";
                            echo "<td> <input type=\"text\" name=\"namhoc\" id=\"namhoc\" size=\"10\" maxlength=\"10\" value=\"2019-2020\" </td>";
                        echo "</tr>";
                        echo "</div>";
                    ...
                    <div class="form-group">
                        <form role="form" action="ktx_inphieuthutienphong_2017.php" method="post">                                                   
                        <button type="submit" class="btn btn-info"> In phiếu thu tiền phòng</button>
                    </form>     
                    </div>   
  		</div>                   
		</div>
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $totalRows = 0;       
                            $stSQL ="select a.ID_SINHVIEN,b.MAHSSV, b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,b.NAMNHAPHOC,c.TENPHONG  "
                                    . "from danhsachnoitrum a, dshssv b,phong c  "
                                    . "where a.ID_SINHVIEN=b.ID_DSHSSV and "
                                    . "  a.ID_PHONG=c.ID_PHONG and a.ID_PHONG=$idphong ";
