...
<html lang="en">
  <head>
    ...
    $link=  clsConnet::DBConnect();   
        ...
        $totalRows = 0;       
        $stSQL ="select * from taisan";// where ID_LOAINOITRU=2";  
      ...
      <section id="main-content">
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                   ...
                   <form name="themtaisan" action="ktx_taisan.php" method="post">
                       <button type="submit" class="btn btn-info">Thêm tài sản</button>
                   </form>
                   </div>
                   <div class="form-group">
                   <form name="xuatexceldanhmuctaisan" action="ktx_xuatexceldanhmuctaisan.php" method="post">
                       <button type="submit" class="btn btn-info">In danh mục tài sản với định dạng excel</button>
                   </form>
                   </div>
