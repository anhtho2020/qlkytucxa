...
<html lang="en">
  <head>
    ...
    $link=  clsConnet::DBConnect();  
        ...
        $totalRows = 0;       
        $query ="select a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,c.TENPHONG,LEFT(c.TENPHONG,1) as DAY, e.MALOPCHUYENNGANH from thechap a,sinhvien b, phong c, danhsachnoitru d, lopchuyennganh e where a.ID_SINHVIEN=b.ID_SINHVIEN and d.ID_SINHVIEN=a.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG and e.ID_LOPCHUYENNGANH=b.ID_LOPCHUYENNGANH";//echo $query;
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        Bảng kê tiền thế chấp từ ngày đến ngày học kỳ-năm học - Ký túc xá
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"xuatexcelbangkethutienphongtungaydenngay\" action=\"ktx_xuatexcel_bangke_thechap_hk-nh-tn-dn.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Học kỳ: </td>";
                        ...
                        echo "</tr>";
                        echo "<input type=\"submit\" class=\"btn btn-info\" value=\"Xuất ra excel_ Bảng kê tiền thế chấp từ ngày đến ngày\">";
                        echo "</form>";   
                        echo "</div>"; 
                       ?>
