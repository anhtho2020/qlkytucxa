...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;       
        $stSQL ="select a.ID_SINHVIEN, b.MASV,b.HODEM,b.TEN,b.DIENCHINHSACH,c.MALOPCHUYENNGANH,a.NGAYNOITRU,d.TENPHONG "
                . "from danhsachnoitru a,sinhvien b,lopchuyennganh c,phong d "
                . "where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and a.ID_PHONG=d.ID_PHONG"
                ." and (b.DIENCHINHSACH='Con thuong binh' or b.DIENCHINHSACH='Con nha ngheo' or b.DIENCHINHSACH='Nguoi tan tat' or b.DIENCHINHSACH='Tu quan')";  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2>Thống kê sinh viên Chính sách </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thongkesinhviendienchinhsachtungaydenngay\" action=\"ktx_XuatExcel_SinhVien_ChinhSach_TuNgayDenNgay.php\" method=\"post\">";
                        echo "<tr>";
