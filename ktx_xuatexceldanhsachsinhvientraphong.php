...
//    $workSheet->setCellValueByColumnAndRow(7, 7, 'PHÒNG');
    $workSheet->setCellValueByColumnAndRow(7, 7, ' NGÀY TRẢ ');
...
//    $workSheet->setCellValueByColumnAndRow(9, 7, 'GHI CHÚ');
    ...
    $query ="select a.ID_SINHVIEN,a.NGAYTRAPHONG, c.MASV, c.HODEM,c.TEN, c.NGAYSINH,c.CMND,c.NOISINH,e.MALOPCHUYENNGANH from danhsachtraphong a,sinhvien c, lopchuyennganh e  where   (a.ID_SINHVIEN=c.ID_SINHVIEN) and  (c.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH)";  
...
//        $workSheet->setCellValueByColumnAndRow($tuCot+7, $tuDong, $row->TENPHONG);
        $workSheet->setCellValueByColumnAndRow($tuCot+7, $tuDong, $row->NGAYTRAPHONG);
