...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH HSSV NỘP TIỀN THẾ CHẤP ');
    ...
    $workSheet->setCellValueByColumnAndRow(6, 7, 'TIỀN THẾ CHẤP');
    ...
    $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,b.MASV,b.HODEM,"
            . "b.TEN,b.PHAI,b.NGAYSINH,c.NGAYNOITRU,d.TENPHONG "
