...
$now = getdate(); 
    ...
    $query_kt ="select * from dsphieuthutienphongkhach where ID_THUTIENPHONGKHACH=$idthutienphongkhach";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.ID_PHONG,a.NGAYMUON,a.SONGAY,a.DONGIA,a.THANHTIEN,"
            . "a.NGAYTHU,a.NGUOITHU,a.DIENGIAI,"
                . " b.MAKHACH,b.HODEM,b.TEN,c.TENPHONG from thutienphongkhach a,khach b, phong c "
            . "where a.ID_KHACH=b.ID_KHACH and a.ID_PHONG=c.ID_PHONG and a.ID_THUTIENPHONGKHACH=$idthutienphongkhach";  
//    echo $query;
    $result=mysql_query($query, $connect);
    $somautin=  mysql_num_rows($result);
    

    $query_ins ="select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.ID_PHONG,a.NGAYMUON,a.SONGAY,a.DONGIA,a.THANHTIEN,"
            . "a.NGAYTHU,a.NGUOITHU,a.DIENGIAI,"
                . " b.MAKHACH,b.HODEM,b.TEN,c.TENPHONG from thutienphongkhach a,khach b, phong c "
            . "where a.ID_KHACH=b.ID_KHACH and a.ID_PHONG=c.ID_PHONG and a.ID_THUTIENPHONGKHACH=$idthutienphongkhach";  
//    echo $query;
    ...
    $idlt_insert=$row_insert["ID_KHACH"];
    $idphong_insert=$row_insert["ID_PHONG"];
    $ngaymuon_insert=$row_insert["NGAYMUON"];
    $songay_insert=$row_insert["SONGAY"];
    ...
    $diengiai_insert=$row_insert["DIENGIAI"];
    $query_insert="insert into dsphieuthutienphongkhach (ID_THUTIENPHONGKHACH,ID_KHACH,ID_PHONG,NGAYMUON,SONGAY,DONGIA,"
            . "THANHTIEN,NGAYTHU,NGAYINPHIEU,NGUOITHU,DIENGIAI) "
            . "Values($idthutienphongkhach,$idlt_insert,$idphong_insert,'$ngaymuon_insert',$songay_insert,"
            . "$dongia_insert,$thanhtien_insert,'$ngaythu_insert','$ngayinphieu','$nguoithu_insert','$diengiai_insert')";
    mysql_query($query_insert, $connect);
    //echo $query_insert;
    
    while($row=mysql_fetch_object($result)){
        $workSheet->setCellValueByColumnAndRow(6, 5, $row->ID_THUTIENPHONGKHACH);
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
        ...
        $workSheet->setCellValueByColumnAndRow(1,10,'Tiền mướn phòng');
        $workSheet->setCellValueByColumnAndRow(1,11,$row->THANHTIEN);
        $workSheet->setCellValueByColumnAndRow(1,12,convert_number_to_words($row->THANHTIEN));
...
//        $workSheet->setCellValueByColumnAndRow(7, $tuDong, $tongsotien);
    ...
    $name="phieuthutienphongkhach.xls";
    //header('Content-Type: application/vnd.ms-excel');
    ...
    echo "</script>";
    echo "<a  href=\"ktx_danhsachphongkhachdathutien.php\"> Tiep tuc </a>";
}    
