          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách HSSV chưa nộp tiền phòng 2017 </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"xuatexcelbangkethutienphongtungaydenngay\" action=\"ktx_xuatexcel_tk_sv_chua_noptienphong_hk_nh2017.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Học kỳ: </td>";
...
//                //. " a.ID_SINHVIEN not in (select ID_SINHVIEN from thutienphongsinhvien where HOCKY='$hocky' and NAMHOC='$namhoc' and ID_SINHVIEN is not null)";//echo $query;
