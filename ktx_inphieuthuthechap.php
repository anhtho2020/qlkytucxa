...
//    ob_start();
    $link=  clsConnet::DBConnect();
        ...
        $totalRows = 0;       
        $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.GHICHU, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI from thechap a, sinhvien b where a.ID_SINHVIEN=b.ID_SINHVIEN ";  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Xuất phiếu thu sinh viên nộp tiền thế chấp </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thuthechap\" action=\"ktx_xuatexcelphieuthuthechap.php\" method=\"post\">";
                        echo "<tr>";
