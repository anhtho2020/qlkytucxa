          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách SVLT nộp tiền phòng theo học kỳ- năm học</h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"xuatexcelbangkethutienphongtungaydenngay\" action=\"ktx_xuatexcel_tk_sv_da_noptienphong_hk_nh.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Học kỳ: </td>";
