...
<html lang="en">
    ...
    <body>
        <script>
            function xoadshssv(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thuchienxoadshssv2017.php?iddshssv="+id;
                }
            }
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> DANH SÁCH HỌC SINH- SINH VIÊN TỪ KHÓA 2017 </h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                        ...
                        echo "<form name=\"themhocsinhsinhvien\" action=\"thuchienthemhocsinhsinhvien2017.php\" method=\"post\">";
                        echo "<div>"; 
                        ...
                        echo "<tr>";
                        echo "<th> Số hồ sơ: </th>";
                        echo "<td> <input type=\"text\" name=\"sohoso\" id=\"sohoso\" size=\"5\" maxlength=\"5\" value=\"\"> </td>";
                        echo "</tr>";
                        
                        echo "<tr>";
                        echo "<th> Năm nhập học: </th>";
                        echo "<td> <input type=\"text\" name=\"namnhaphoc\" id=\"namnhaphoc\" size=\"4\" maxlength=\"5\" value=\"\"> </td>";
                        echo "</tr>";
                       ...
                       echo "</div>";
                        ...
                        echo "<tr>";
                        echo "<td> Nơi sinh: </td>";
                        echo "<td> <input type=\"text\" name=\"noisinh\" id=\"noisinh\" size=\"20\" maxlength=\"20\" value=\"\"></td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td> Địa chỉ: </td>";
                        ...
                        echo "<tr>";
                        echo "<td> Email: </td>";
                        echo "<td> <input type=\"text\" name=\"email\" id=\"email\" size=\"36\" maxlength=\"36\" value=\"\"></td>";
                        echo "</tr>";
                        echo "</div>";
                        echo "</div>";
                        ...
                        echo "<td> <input type=\"text\" name=\"dienchinhsach\" id=\"dienchinhsach\" size=\"30\" maxlength=\"30\" value=\"\"></td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td> Ghi chú: </td>";
                        echo "<td> <input type=\"text\" name=\"ghichu\" id=\"ghichu\" size=\"50\" maxlength=\"50\" value=\"\"></td>";
                        echo "</tr>";
                        //echo "<tr>";
                        //echo "<td> Email: </td>";
                        //echo "<td> <input type=\"text\" name=\"email\" id=\"email\" size=\"36\" maxlength=\"36\" value=\"\"></td>";
                        ...
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"ktx_danhsachsinhviendangkynoitru2017.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> Danh sách HSSV đăng ký nội trú </button>";
                        echo "</form>";  
                        echo "</div>"; 
                    ?>
  		</div>                   
...
<!--                                  <th>Tên</th>-->
                        ...
                        <?php
                            ...
                            $totalRows_khach = 0;       
                            $stSQL_khach ="select * from dshssv";  
                                               ...
                                               echo "<div class=\"modal-dialog\">";
                                                    echo "<div class=\"modal-content\">";
                                                      echo "<div class=\"modal-header\">";
                                                          ...
                                                          echo " <h4 class=\"modal-title\">Cập nhật thông tin HSSV </h4>";
                                                        echo "</div>";
                                                        echo "<div class=\"modal-body\">";
                                                            echo "<form role=\"form\" action=\"thuchiencapnhatthongtinhocsinhsinhvien2017.php\" method=\"post\">";
                                                                echo "<div class=\"form-group\">";
                                                                ...
                                                                echo "<input type=\"hidden\" name=\"iddshssv\" value=\"".$row["ID_DSHSSV"]."\" />";
                        ...
                        if($_SESSION["quyen"]=="QT")
                        {
                                  echo "<td>";
                                   //echo "<a href=\"ktx_edit.php?idphong=".$row_phong["ID_PHONG"]."\" class=\"btn btn-primary btn-xs\">Xem chi tiết</a>";
                                    ...
                                    //echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoadshssv('".$row["ID_DSHSSV"]."')\">Xóa</a></button>";
