...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5,' BẢNG KÊ THU TIỀN Ở NHÀ KHÁCH THÁNG '.$thang.' NĂM '.$nam);
...
{    
    $query ="select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.NGAYTHU,a.SONGAY,a.DONGIA,a.THANHTIEN,"
            . "a.DIENGIAI,b.HODEM,b.TEN,c.TENPHONG from thutienphongkhach a,khach b, phong c, "
            . "dskhachnoitru d where a.ID_KHACH=b.ID_KHACH and d.ID_KHACH=a.ID_KHACH and c.ID_PHONG=d.ID_PHONG "
            . "and (date_format(a.NGAYTHU,'%m')=$thang) and (date_format(a.NGAYTHU,'%Y')=$nam) and (a.NGAYTHU>='$tungay' and a.NGAYTHU <= '$denngay')";//echo $query;
