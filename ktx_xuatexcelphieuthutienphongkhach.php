...
$query = "select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.SONGAY,a.DONGIA,a.THANHTIEN,a.NGAYTHU,a.NGUOITHU,b.MAKHACH,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,b.DIACHI,b.DIENTHOAI,c.TENPHONG from thutienphongkhach a, khach b, phong c, danhsachnoitru d where a.ID_KHACH=b.ID_KHACH and b.ID_KHACH=d.ID_KHACH and d.ID_PHONG=c.ID_PHONG and d.ID_PHONG=$idphong and b.MAKHACH='$makhach'";
//echo $query;
