...
//    $ngaytrathechap=$_GET["ngaytrathechap"];
    ...
    $query_kt ="select * from dsphieuchithechap where ID_THECHAP=$idthechap";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPCHUYENNGANH "
            . "from thechap a, sinhvien b ,lopchuyennganh c "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and "
            . "a.ID_THECHAP=$idthechap";  
//    echo $query;
    $result=mysql_query($query, $connect);
    $somautin=  mysql_num_rows($result);
    
    $query_ins ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, b.MASV,"
            . "b.HODEM,b.TEN,b.NGAYSINH from thechap a, sinhvien b "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_THECHAP=$idthechap";  
//    echo $query_ins;
    ...
    $idlt_insert=$row_insert["ID_SINHVIEN"];
    ...
    $query_insert="insert into dsphieuchithechap(ID_THECHAP,ID_SINHVIEN,NGAYTHECHAP,NGAYTRATHECHAP,SOTIEN,"
            . "HOCKY,NAMHOC,GHICHU) "
            . "Values($idthechap,$idlt_insert,'$ngthechap_insert','$ngaytrathechap',$sotien_insert,"
            . "'$hk_insert','$nh_insert','$nguoithu_insert')";
    mysql_query($query_insert, $connect);
//    echo $query_insert;
    
    while($row=mysql_fetch_object($result)){
        $workSheet->setCellValueByColumnAndRow(6, 5, $row->ID_THECHAP);
