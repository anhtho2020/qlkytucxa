          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Thống kê phiếu thu tiền điện nước sinh viên </h2>
                   ...
                   echo "<div class=\"form-group\">";    
                        echo "<form name=\"thongkephieuthutiendiennuocsinhvientungaydenngay\" action=\"ktx_xuatexcel_thongke_phieuthutiendiennuoc_sv_tungaydenngay.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
