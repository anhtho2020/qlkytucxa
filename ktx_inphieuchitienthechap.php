...
<html lang="en">
  <head>
    ...
    <body>
        <script>
            function xoadstrathechap(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thucHienXoaDanhSachTraTheChap.php?iddstrathechap="+id;
                }
            }
            function inphieuchitrathechap(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="inPhieuChiTraTheChap.php?iddstrathechap="+id;
                }
            }
        </script>
    <?php  
        ...
        $totalRows = 0;       
        $query ="select a.ID_DSTRATHECHAP,a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.NGAYTRATHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.GHICHU, b.MASV,"
                . "b.HODEM,b.TEN,b.NGAYSINH,b.PHAI "
                . "from dstrathechap a, sinhvien b "
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Xuất phiếu chi sinh viên nhận lại tiền thế chấp </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"chithechap\" action=\"ktx_xuatexcelphieuchitienthechap.php\" method=\"post\">";
                        echo "<tr>";
...
//                            echo "<td> <input type=\"date\" name=\"ngaythechap\" id=\"ngaythechap\" value=\"\"> </td></br></br>";
                        echo "<input type=\"submit\" class=\"btn btn-info\" value=\"Xuất ra excel_ Phiếu chi tiền thế chấp\">";
                        echo "</form>";   
                        echo "</div>"; 
                           * 
                           */
                    ...
                    <div class="form-group">
                        <form role="form" action="ktx_thechap.php" method="post">                                                   
                        ...
                        ?>  
                            ...
                            <tr>
                                ...
                                if($_SESSION["quyen"]=="KTKTX")
                                {
                                    ...
                                    echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoadstrathechap('".$row["ID_DSTRATHECHAP"]."')\">Xóa</a></button>";
                                    echo "<button class=\"btn btn-primary btn-xs\" onClick=\"inphieuchitrathechap('".$row["ID_DSTRATHECHAP"]."')\">In phiếu</a></button>";
