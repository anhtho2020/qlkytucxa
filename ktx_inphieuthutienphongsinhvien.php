...
//                }
            ...
            function load(){
                ...
                var url="ktx_inphieuthutienphongsinhvien.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    echo "<div class=\"form-group\">";
                        echo "<form name=\"danhsachsinhviennoptienphong\" action=\"ktx_danhsachsinhviennoptienphong.php\" method=\"post\">";
                        echo "<div>"; 
                        echo "<div class=\"form-group\">";
                        echo "<tr>";
                        echo "<th > Tên dãy: </th>";
                        ...
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"ktx_xuatexceldanhsachsinhviennoptienphong.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> In danh sách </button>";
                        echo "</form>";  
                        echo "</div>"; 
                    
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"ktx_thutienphong.php\" method=\"post\">";
		...
		<!--</div>-->
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            $totalRows = 0;       
        $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.SOTHANGNOP,a.DONGIATHANG,a.MUCGIAM,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,b.MASV,"
