...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH PHIẾU THU TIỀN THẾ CHẤP ');
...
//    $workSheet->mergeCells('C7:D7');
    ...
    $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU,"
            ...
            //. " and (a.NGAYINPHIEU>='$tungay' and a.NGAYINPHIEU<='$denngay')";
...
//    echo $query;
    ...
    $name="dsphieuthutienthechap.xls";
    //header('Content-Type: application/vnd.ms-excel');
