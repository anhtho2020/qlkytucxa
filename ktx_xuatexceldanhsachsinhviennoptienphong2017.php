...
//    
    ...
    $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.THANHTIEN,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,a.GHICHU,b.MAHSSV,b.HODEM,b.TEN,b.NGAYSINH,d.TENPHONG from ";
        $query.= "thutienphongsinhvien2017 a,dshssv b,danhsachnoitrum c, phong d where ";
        $query.="a.ID_SINHVIEN=b.ID_DSHSSV and a.ID_SINHVIEN=c.ID_SINHVIEN and c.ID_PHONG=d.ID_PHONG ";
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+5, $tuDong, $row->THANHTIEN);
