...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $now = getdate(); 
    $ngaytrathechap=$now["year"].'-'.$now["mon"].'-'.$now["mday"];
//    $ngaytrathechap=$_GET["ngaytrathechap"];
    
    $query_kt ="select a.ID_DSTRATHECHAP,a.SOTIEN,b.HODEM,b.TEN from dstrathechap a,sinhvien b where ID_DSTRATHECHAP=$iddstrathechap";  //echo $query_kt;
...
//    $workSheet->setCellValueByColumnAndRow(0, 3, 'BỘ PHẬN QUẢN LÝ KÝ TÚC XÁ');
    ...
    $workSheet->setCellValueByColumnAndRow(1, 5, 'PHIẾU CHI');
    $workSheet->getStyle('B5')->getFont()->setSize(14);
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_DSTRATHECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.NGAYTRATHECHAP,a.SOTIEN,a.SOTIEN,a.HOCKY,a.NAMHOC, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPCHUYENNGANH "
            . "from dstrathechap a, sinhvien b ,lopchuyennganh c "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and "
            . "a.ID_DSTRATHECHAP=$iddstrathechap";  
    //echo $query;
    
    $result=mysql_query($query, $connect);
    $somautin=  mysql_num_rows($result);
    
    $query_ins ="select a.ID_DSTRATHECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.NGAYTRATHECHAP,a.SOTIEN,a.SOTIEN,a.HOCKY,a.NAMHOC, b.MASV,"
            . "b.HODEM,b.TEN,b.NGAYSINH from dstrathechap a, sinhvien b "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and ID_DSTRATHECHAP=$iddstrathechap";  
    
//    echo $query_ins;
    $result_ins=mysql_query($query_ins, $connect);
    $somautin_ins=  mysql_num_rows($result_ins);
    ...
    $row_insert = mysql_fetch_array ($result_ins);
    $idsv_insert=$row_insert["ID_SINHVIEN"];
    ...
    $query_insert="insert into dsphieuchithechap(ID_THECHAP,ID_SINHVIEN,NGAYTHECHAP,NGAYTRATHECHAP,SOTIEN,"
            . "HOCKY,NAMHOC) "
            . "Values($iddstrathechap,$idsv_insert,'$ngthechap_insert','$ngaytrathechap',$sotien_insert,"
            . "'$hk_insert','$nh_insert')";
...
//    echo $query_insert;
    ...
    while($row=mysql_fetch_object($result)){
        $workSheet->setCellValueByColumnAndRow(6, 5, $row->ID_DSTRATHECHAP);
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
        ...
        $workSheet->setCellValueByColumnAndRow(1, 10, 'Hoàn tiền thế chấp');
    ...
    //$query_delete="delete from thechap where ID_THECHAP='".$idthechap."'";
    //$result_delete=mysql_query($query_delete, $connect);
    ...
    $workSheet->mergeCells("A14:B14");
        ...
        $workSheet->setCellValueByColumnAndRow(0, 20, ' Người nhận ' );
    ...
    echo "</script>";
    echo "<a  href=\"ktx_tratienthechap.php\"> Tiep tuc </a>";
}  
     * 
     */  
