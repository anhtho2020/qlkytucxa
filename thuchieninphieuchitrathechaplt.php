...
//    $ngaytrathechap=$_GET["ngaytrathechap"];
    ...
    $query_kt ="select * from dsphieuchithechaplt where ID_THECHAPLT=$idthechaplt";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPLT from thechaplt a, lienthong b, loplt c "
            . "where a.ID_LIENTHONG=b.ID_LIENTHONG and b.ID_LOP=c.ID_LOPLT and a.ID_THECHAPLT=$idthechaplt";  
//    echo $query;
    $result=mysqli_query($connect,$query);
    $somautin=  mysqli_num_rows($result);
    
    $query_ins ="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPLT from thechaplt a, lienthong b, loplt c "
            . "where a.ID_LIENTHONG=b.ID_LIENTHONG and b.ID_LOP=c.ID_LOPLT and  a.ID_THECHAPLT=$idthechaplt";  
    //echo $query_ins;
    ...
    $query_insert="insert into dsphieuchithechaplt(ID_THECHAPLT,ID_LIENTHONG,NGAYTHECHAP,NGAYTRATHECHAP,"
            . "SOTIEN,HOCKY,NAMHOC) "
            . "Values($idthechaplt,$idlt_insert,'$ngthechap_insert','$ngaytrathechap',$sotien_insert,"
            . "'$hk_insert','$nh_insert')";
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
    ...
    $query_delete="delete from thechaplt where ID_THECHAPLT='".$idthechaplt."'";
    ...
    echo "</script>";
    echo "<a  href=\"ktx_tratienthechaplt.php\"> Tiep tuc </a>";
}    
