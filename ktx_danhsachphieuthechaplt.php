    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_danhsachphieuthechaplt.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
    <?php  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách phiếu thu tiền thế chấp- LT </h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                    echo "<div>"; 
                        echo "<form name=\"danhsachthechaplt\" action=\"ktx_danhsachphieuthechaplt.php\" method=\"post\">";
                    ...
                    echo "<div>";
                        echo "<form name=\"xuatphiethuthechap\" action=\"ktx_xuatexceldanhsachphieuthuthechaplt.php\" method=\"post\">";
                    ...
                    echo "</div>";
                    echo "<div>";
                        echo "<form name=\"thutienthechap\" action=\"ktx_thechap_svlt.php\" method=\"post\">";
                        ...
                        <?php
                            ...
                            {    
                                ...
                                {                                   
                                    ...
                                    echo "<div class=\"modal fade\" id=\"modalcapthechaplt$i\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">";
...
//                                    echo "<td>"; echo $row["NGAYSINH"]; echo "</td>";
                                    ...
                                    {
                                    echo "<td>";
                                    echo "<a href=\"#modalcapthechaplt$i\" class=\"btn btn-warning btn-xs\" data-toggle=\"modal\">Sửa</a>";
                                    echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoathechap('".$row["ID_THECHAPLT"]."')\">Xóa</a></button>";
