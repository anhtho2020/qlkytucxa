...
<html lang="en">
  <head>
    ...
    $link=  clsConnet::DBConnect();  
        ...
        $totalRows = 0;       
        $query ="select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.NGAYTHU,a.SONGAY,a.DONGIA,a.THANHTIEN,"
                . "a.DIENGIAI,b.MAKHACH,b.HODEM,b.TEN,b.NGAYSINH,c.TENPHONG "
                . "from thutienphongkhach a,khach b, phong c, dskhachnoitru d where a.ID_KHACH=b.ID_KHACH "
                . "and d.ID_KHACH=a.ID_KHACH and c.ID_PHONG=d.ID_PHONG";//echo $query;
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2>Thống kê thu tiền khách mướn phòng từ ngày đến ngày </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"xuatexcelthongkethutienkhachmuonphongthangnamtungaydenngay\" action=\"ktx_xuatexcel_thongke_thutienkhach_muonphong_thangnam-tungay_denngay.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Tháng: </td>";
                            echo "<td> <input type=\"text\" name=\"thang\" id=\"thang\" size=\"2\" maxlength=\"2\" value=\"\"> </td>";
                            echo "<td> Năm: </td>";
                            echo "<td> <input type=\"text\" name=\"nam\" id=\"nam\" size=\"4\" maxlength=\"4\" value=\"\"> </td></br></br>";
                        echo "</tr>";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                        ...
                        echo "</tr>";
                        echo "<input type=\"submit\" class=\"btn btn-info\" value=\"Xuất ra excel_ Bảng kê thu tiền khách từ ngày đến ngày\">";
                        echo "</form>";   
                        echo "</div>"; 
                       ?>
                    <div class="form-group">
                        <form role="form" action="ktx_khachthuephong.php" method="post">                                                   
                            <button type="submit" class="btn btn-info">Khách mướn phòng</button>
                        </form>     
                    </div>   
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        ?>  
                            ...
                            <tr>
                                <td><?=$i?></td>
                                <td><?=$row["ID_THUTIENPHONGKHACH"]?></td>
                                <td><?=$row["MAKHACH"]?></td>
                                <td><?=$row["HODEM"]?></td>
                                <td><?=$row["TEN"]?> </td>
                                <td><?=$row["NGAYSINH"]?></td>
