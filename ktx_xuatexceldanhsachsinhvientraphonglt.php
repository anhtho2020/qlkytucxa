...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, ' DANH SÁCH SINH VIÊN LIÊN THÔNG TRẢ PHÒNG ');
...
//    $workSheet->setCellValueByColumnAndRow(9, 7, 'GHI CHÚ');
    ...
    $query ="select a.ID_LIENTHONG,a.NGAYTRAPHONG, c.MASV, c.HODEM,c.TEN, c.NGAYSINH,c.CMND,c.DIACHI,"
            . "e.MALOPLT "
            . "from dstraphonglt a,lienthong c, loplt e  "
