...
//   
    ...
    $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.DONGIA,a.NGAYTHU,a.NGAYINPHIEU,a.HOCKY,"
            . "a.NAMHOC,a.NGUOITHU,b.HODEM,b.TEN,c.TENPHONG,e.NGAYNOITRU "
            . " from dsphieuthutienphongsinhvien a, sinhvien b, phong c,danhsachnoitru e "
            . " where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=e.ID_SINHVIEN and e.ID_PHONG=c.ID_PHONG";
...
//    $workSheet->getStyle("C".(9+$somautin).":L".(9+$somautin))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    $name="dsphieuthutienphongsinhvien.xls";
    //header('Content-Type: application/vnd.ms-excel');
