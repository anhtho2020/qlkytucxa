...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;       
        $query ="select a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.ID_PHONG,a.NGAYMUON,a.SONGAY,a.DONGIA,a.THANHTIEN,a.NGAYTHU,a.NGAYINPHIEU"
                . ",a.NGUOITHU,b.HODEM,b.TEN,c.TENPHONG "
                . "from dsphieuthutienphongkhach a,khach b, phong c where a.ID_KHACH=b.ID_KHACH and a.ID_PHONG=c.ID_PHONG";
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Thống kê Phiếu thu Khách mướn phòng từ ngày đến ngày </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thongkephieuthutienphongkhachtungaydenngay\" action=\"ktx_xuatexcel_thongke_phieuthu_tienphongkhach_tungaydenngay.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                        ...
                        echo "</tr>";
                        echo "<input type=\"submit\" class=\"btn btn-info\" value=\"Thống kê phiếu thu tiền phòng từ ngày đến ngày\">";
                        echo "</form>";   
                        echo "</div>"; 
                       ?>
                    ...
                    <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                                ...
                                <td width="13%">NGÀY MƯỚN PHÒNG</td>
                                <td width="5%">SỐ NGÀY</td>
                                <td width="15%"> ĐƠN GIÁ</td>
                                <td width="15%">THÀNH TIỀN</td>
                                <td width="13%">NGÀY IN PHIẾU</td>
                                <td width="25%">NGƯỜI THU</td>
                                <td width="5%">PHÒNG</td>
                                <td width="8%">SỐ PHIẾU</td>
                            </tr>
                          </thead>
                          <tbody>
                        <?php
