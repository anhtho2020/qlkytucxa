...
//    $workSheet->setCellValueByColumnAndRow(0, 15, 'NGƯỜI THU');
    ...
    $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,b.CMND, b.MAHSSV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,b.DIACHI from thechap2017 a, dshssv b  where a.ID_SINHVIEN=b.ID_DSHSSV and b.MAHSSV='$masv'";// and a.NGAYTHECHAP='$ngaythechap')";  
    //echo $query;
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
        $workSheet->setCellValueByColumnAndRow(1, 9, $row->DIACHI);
