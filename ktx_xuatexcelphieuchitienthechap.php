...
//    $workSheet->setCellValueByColumnAndRow(0, 15, 'NGƯỜI THU');
    ...
    $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.GHICHU, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPCHUYENNGANH from thechap a, sinhvien b ,lopchuyennganh c where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and (b.MASV='$masv' and a.NGAYTHECHAP='$ngaythechap')";  
    //echo $query;
