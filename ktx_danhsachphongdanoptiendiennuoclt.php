        ...
        <script>
            ...
            function inphieuthutiendiennuoc(id){
                if(confirm('Bạn có chắc in phiếu này không?')){
                    window.location="ktx_inphieuthudiennuoc_dg_cs_tt_lt.php?idthutiendiennuoclt="+id;
                }
            }
            ...
            function load(){
                ...
                var url="ktx_danhsachphongdanoptiendiennuoclt.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
    <?php  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> In phiếu thu tiền điện nước </h2>
                   ...
                   <div class="form-group"> 
                    <form role="form" action="ktx_xuatexceldanhsachphongdanoptiendiennuoclt.php" method="post">                                                   
                   ...
                   <?php
                    echo "<div>"; 
                        echo "<form name=\"danhsachphongdanoptiendiennuoclt\" action=\"ktx_danhsachphongdanoptiendiennuoclt.php\" method=\"post\">";
...
//                        echo "</tr>";
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                        $totalRows = 0;       
        $query ="select a.ID_THUTIENDIENNUOCLT,a.ID_LIENTHONG,a.GIADIEN,a.CSDIENCU,a.CSDIENMOI,a.GIANUOC,"
                . "a.CSNUOCCU,a.CSNUOCMOI,a.THANHTIEN,a.NGAYTHU,a.THANGNOP,a.NGUOITHU,b.MASV,b.HODEM,"
                . "b.TEN,b.NGAYSINH,c.TENPHONG from ";
        $query.= "thutiendiennuoclt a,lienthong b, phong c where ";
        $query.="a.ID_LIENTHONG=b.ID_LIENTHONG and a.ID_PHONG=c.ID_PHONG and a.ID_PHONG=$idphong and "
                . "a.ID_THUTIENDIENNUOCLT not in (select ID_THUTIENDIENNUOCLT from dsphieuthutiendiennuoclt  where ID_THUTIENDIENNUOCLT is not null)";
        //echo $query;
                            ...
                            <tr>
                                ...
                                <!--<td><span class="badge bg-important"> </span></td>-->
                                    ...
                                    if($_SESSION["quyen"]=="QT"){
                                        ...
                                        echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoaphongnoptiendiennuoc('".$row["ID_THUTIENDIENNUOCLT"]."')\">Xóa</a></button>";
                                        echo "<button class=\"btn btn-primary btn-xs\" onClick=\"inphieuthutiendiennuoc('".$row["ID_THUTIENDIENNUOCLT"]."')\">In phiếu thu</a></button>";
                                    }
