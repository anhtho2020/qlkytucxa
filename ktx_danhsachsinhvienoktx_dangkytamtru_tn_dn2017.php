...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;  
        /*
        $query ="select a.ID_SINHVIEN,a.NGAYTAMTRU,b.ID_PHONG,b.NGAYNOITRU, c.MASV, c.HODEM,c.TEN, c.NGAYSINH,c.CMND,c.NOISINH,d.TENPHONG,"
                . "e.MALOPCHUYENNGANH,b.GHICHU "
                . "from dangkytamtru a,danhsachnoitru b, sinhvien c, phong d, lopchuyennganh e  "
                . "where  (a.ID_SINHVIEN=b.ID_SINHVIEN) and (a.ID_SINHVIEN=c.ID_SINHVIEN) and (b.ID_PHONG=d.ID_PHONG) and "
                . "(c.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH)";  */
        $query="select a.ID_DANHSACHNOITRU,a.ID_SINHVIEN,a.NGAYNOITRU,c.ID_PHONG,b.MAHSSV, b.HODEM,b.TEN, b.NGAYSINH,b.CMND,b.DIACHI,c.TENPHONG,"
                . " b.GHICHU "
                . "from danhsachnoitru a, dshssv b, phong c  "
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách sinh viên đăng ký tạm trú từ ngày đến ngày 2017</h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                        ...
                        echo "<form name=\"danhsachsinhvienoktxdangkytamtru\" action=\"ktx_xuatexcel_danhsachsinhvienoktx_dangkytamtru_tndn2017.php\" method=\"post\">";
//                        echo "<tr>";
//                            echo "<td> Học kỳ: </td>";
