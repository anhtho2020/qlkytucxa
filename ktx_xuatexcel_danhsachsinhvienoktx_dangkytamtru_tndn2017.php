<?php
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, ' DANH SÁCH HSSV Ở KÝ TÚC XÁ ĐĂNG KÝ TẠM TRÚ '.$tungay.' đến '.$denngay);
...
//    $workSheet->setCellValueByColumnAndRow(2, 7, 'HỌ TÊN');
    ...
    $workSheet->setCellValueByColumnAndRow(5, 7, 'ĐIA CHỈ');
