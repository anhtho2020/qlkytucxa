...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $query_kt ="select * from dsphieuthuthechaplt where ID_THECHAPLT=$idthechaplt";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,"
            . "a.NGUOITHU, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPLT from thechaplt a, lienthong b ,"
   ...
   $result=mysqli_query($connect,$query);
    ...
    $query_ins ="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,"
            . "a.NGUOITHU, b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPLT from thechaplt a, lienthong b ,"
            . "loplt c where a.ID_LIENTHONG=b.ID_LIENTHONG and b.ID_LOP=c.ID_LOPLT and a.ID_THECHAPLT=$idthechaplt";  
    //echo $query;
   ...
   $result_ins=mysqli_query($connect,$query_ins);
    ...
    $query_insert="insert into dsphieuthuthechaplt(ID_THECHAPLT,ID_LIENTHONG,NGAYTHECHAP,NGAYINPHIEU,"
            . "SOTIEN,HOCKY,NAMHOC,NGUOITHU) "
            . "Values($idthechaplt,$idlt_insert,'$ngthechap_insert','$ngayinphieu',$sotien_insert,"
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow(1,13,  'Kèm ...');
        $tiennop=$row->SOTIEN;
