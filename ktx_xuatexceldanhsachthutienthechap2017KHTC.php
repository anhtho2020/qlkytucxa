...
//    $workSheet->mergeCells('C7:D7');
    ...
    $workSheet->setCellValueByColumnAndRow(4, 7, 'SỐ PHIẾU');
    $workSheet->setCellValueByColumnAndRow(5, 7, 'THÀNH TIỀN');
    //
    $workSheet->setCellValueByColumnAndRow(6, 7, 'NGÀY THẾ CHẤP');
    ...
    $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.NGUOITHU,"
            . "b.MAHSSV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,c.TENPHONG "
            . "from thechap2017khtc a,dshssv b,phong c "
            . "where a.ID_SINHVIEN=b.ID_DSHSSV and a.ID_PHONG=c.ID_PHONG and "
            . " (a.NGAYTHECHAP>='$tungay' and a.NGAYTHECHAP<='$denngay')";
...
//    echo $query;
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+4, $tuDong, $row->ID_THECHAP);
        $workSheet->setCellValueByColumnAndRow($tuCot+5, $tuDong, $row->SOTIEN);
        $workSheet->setCellValueByColumnAndRow($tuCot+6, $tuDong, $row->NGAYTHECHAP);
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+8, $tuDong,  '');
    ...
    $name="dsthutienthechaptungaydenngayKHTC.xls";
    //header('Content-Type: application/vnd.ms-excel');
