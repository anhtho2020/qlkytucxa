...
//    $workSheet->setCellValueByColumnAndRow(8, 7, 'THÀNH TIỀN');
    ...
    $query="select a.ID_SINHVIEN, b.MASV,b.HODEM,b.TEN,b.DIENCHINHSACH,c.MALOPCHUYENNGANH,a.NGAYNOITRU,d.TENPHONG "
...
//    $workSheet->getColumnDimension('J')->setWidth(14);
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+4, $tuDong, $row->DIENCHINHSACH);
