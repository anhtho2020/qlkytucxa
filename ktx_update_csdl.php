    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_capnhatdienchinhsach.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Cập nhật diện chính sách </h2>
...
//                        echo "<form name=\"capnhatdienchinhsach\" action=\"ktx_capnhatdienchinhsach.php\" method=\"post\">";
//                        echo "<div>"; 
//                        echo "<div class=\"form-group\">";
//                        echo "<tr>";
//                        echo "<th > Tên dãy: </th>";
...
//                        echo "</form>";  
                        ...
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"thuchieninsertdata.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> Insert database </button>";
                        echo "</form>";  
                        echo "</div>"; 

                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"thuchienupdatelopchuyennganh.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> Update table lopchuyennganh </button>";
                        echo "</form>";  
                        echo "</div>"; 
                        
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"thuchienupdatesinhvien.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> Update table sinhvien </button>";
                        echo "</form>";  
                        echo "</div>"; 
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $stSQL ="select a.NGAYNOITRU,a.ID_SINHVIEN,b.MASV,b.HODEM,b.TEN,b.NGAYSINH,"
                                    . "b.PHAI,b.DIENCHINHSACH,c.TENPHONG,"
                                        ...
                                        echo "<div class=\"modal-dialog\">";
                                             echo "<div class=\"modal-content\">";
                                               echo "<div class=\"modal-header\">";
                                                   ...
                                                   echo " <h4 class=\"modal-title\">Cập nhật diện chính sách</h4>";
                                                 echo "</div>";
                                                 echo "<div class=\"modal-body\">";
                                                     echo "<form role=\"form\" action=\"thuchiencapnhatdienchinhsach.php\" method=\"post\">";
                                                         echo "<div class=\"form-group\">";
