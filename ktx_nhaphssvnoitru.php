...
<html lang="en">
  ...
  <body>
      ...
      <script>
            function xoadanhsachhssvnoitru(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thuchienxoadanhsachhssvnoitru.php?idhssvnoitru="+id;
                }
            }
        </script>
      ...
      <section id="main-content">
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Thêm HSSV vào danh sách nội trú </h2>
  		...
  		<div class="panel-body">
                <div class="adv-table editable-table ">
                        ...
                        <div class="panel-body">                   		  
                            <button class="btn btn-info" data-toggle="modal" href="#modalupexcel"> <i class="icon-cloud-upload"> </i> Thêm HSSV </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Thêm HSSV</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form role="form" action="thuchienthemhssv.php" method="post">
                                                <div class="form-group">
                                                    <label for="mahssv">Mã HSSV</label>
                                                    <input type="text" class="form-control" id="mahssv" 
                                                           name="mahssv" placeholder="Nhập mã HSSV">
                                                </div>
                                                <div class="form-group">
                    ...
                    <div class="clearfix">
                              <div class="btn-group">
                                  <form role="form" action="ktx_danhsachhssv_hsnh.php" method="post">
                                      
                                  <button type="submit" class="btn btn-info">Danh sách HSSV </button>
                                </form> 
                              </div>                              
                    </div>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample" style="margin-top:20px">
                                ...
                                <?php
                                    ...
                                    {    
                                        ...
                                        {   
                                            ...
                                            echo "<div class=\"modal fade\" id=\"modalcapnhatdanhsachhssv$i\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">";
                                               echo "<div class=\"modal-dialog\">";
                                                    echo "<div class=\"modal-content\">";
                                                      echo "<div class=\"modal-header\">";
                                                          echo "<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>";
                                                          echo " <h4 class=\"modal-title\">Cập nhật thông tin học sinh sinh viên</h4>";
                                                        echo "</div>";
                                                        echo "<div class=\"modal-body\">";
                                                            echo "<form role=\"form\" action=\"thuchiencapnhatthongtinhssv.php\" method=\"post\">";
                                                                ...
                                                                echo "<div class=\"form-group\">";
                                                                    ...
                                                                    echo "<input type=\"text\" class=\"form-control\" id=\"noisinh\" value=\"".$row["NOISINH"]."\" "; 
                                                                ...
                                                                echo "</div>";
                                                                echo "<input type=\"hidden\" name=\"idhssvnoitru\" value=\"".$row["ID_HSSVNOITRU"]."\" />";
                            ...
                            <?php
                                    ...
                                    echo "<a href=\"#modalcapnhatdanhsachhssv$i\" class=\"btn btn-warning btn-xs\" data-toggle=\"modal\">Sửa</a>";
                                    ...
                                    echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoadanhsachhssvnoitru('".$row["ID_HSSVNOITRU"]."')\">Xóa</a></button>";
