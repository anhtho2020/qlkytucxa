...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->getStyle('E1:L1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $workSheet->setCellValueByColumnAndRow(4, 1, 'CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM');
    $workSheet->mergeCells('E2:L2');
    $workSheet->getStyle('E2:L2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    $workSheet->getStyle('A6:L6')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
//    $workSheet->getStyle('A6')->getFont()->setBold(true);
    ...
    $query="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN, b.MAHSSV, b.HODEM, b.TEN, a.THANHTIEN,a.NGAYTHU,a.HOCKY,a.NAMHOC,"
            . "a.NGUOITHU,c.TENPHONG,a.SOTHANGNOP,a.MUCGIAM from thutienphongsinhvien2017khtc a, dshssv b, phong c "
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+4, $tuDong, ' ');
    ...
    $name="dssvnoptienphongtungaydenngayKHTC.xls";
    //header('Content-Type: application/vnd.ms-excel');
