        ...
        <script>
            function xoaphieuthutienphongsv(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thuchienxoaphieuthutienphongsinhvien2017.php?idthutienphongsinhvien="+id;
                }
            }
            ...
            function load(){
                ...
                var url="ktx_xoaphieuthutienphongsinhvien2017.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
    <?php  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                   ...
                   <div class="form-group"> 
                    <form role="form" action="ktx_xuatexceldanhsachsinhviennoptienphong2017.php" method="post">                                                   
                   ...
                   echo "<div>"; 
                        echo "<form name=\"xoaphieuthutienphongsinhvien\" action=\"ktx_xoaphieuthutienphongsinhvien2017.php\" method=\"post\">";
...
//                        echo "</tr>";
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                        $totalRows = 0;       
        $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.THANHTIEN,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,b.MAHSSV,"
