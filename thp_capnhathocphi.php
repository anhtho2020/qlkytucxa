...
<html lang="en">
  ...
  <body>
    <script>
            function xoanganhlt(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="xoadanhmuchocphi.php?idnganhlt="+id;
                }
            }
    ...
    <?php  
        ...
        if($dongia != '' && $muchocphi != '')
        {
            $query="insert into danhmuchocphi(DONGIA,MUCHOCPHI) "
                    . "values($dongia,'$muchocphi')";
          ...
          <section class="wrapper">         
               ...
               <!--<div class="panel panel-default">-->
                    ...
                    <?php
                        ...
                        echo "<form name=\"themloplt\" action=\"thp_capnhathocphi.php\" method=\"post\">";
                        
                        echo "<div class=\"form-group\">";
                        echo "<tr>";
                        echo "<th> Giá học phí: </th>";
                        echo "<td> <input type=\"text\" name=\"dongia\" id=\"dongia\" size=\"10\" maxlength=\"12\" value=\"\"> </td>";
                        
                        echo "< Mức học phí: </td>";
                            echo "<td> <input type=\"text\" name=\"muchocphi\" id=\"muchocphi\" size=\"34\" maxlength=\"34\" value=\"\"></td>";
                        echo "</tr>";
                       echo "</div>";
...
<!--                                    <th>MÃ LỚP</th>
                              ...
                              <?php
                                $totalRows_nganh = 0;       
                                $query_nganh ="select * from danhmuchocphi ";
                                ...
                                $totalRows_nganh=mysql_num_rows($result_nganh);
                                    ...
                                    {    
                                        $i=0;                    
                                        while ($row = mysql_fetch_array ($result_nganh))     
                                        {   
                                            $i+=1;
                              ...
                              <tr class="">
                                  ...
                                  <?php
                                    if($_SESSION["quyen"]=="QT")
                                    {
                                        ...
                                        echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoadanhmuchocphi('".$row["ID_DANHMUCHOCPHI"]."')\">Xóa</a></button>";
                                              echo "</td>";
                                    }
