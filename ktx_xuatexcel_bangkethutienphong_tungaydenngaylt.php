...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'BẢNG KÊ THU TIỀN Ở KHU KTX SVLT HỌC KỲ '.$hocky.' NĂM HỌC '.$namhoc);
...
{  
    $query ="select a.ID_TIENPHONGSINHVIENLT, a.ID_LIENTHONG,a.DONGIA,a.HOCKY,a.NAMHOC,a.NGAYTHU,b.MASV,"
            . "b.HODEM,b.TEN,b.NGAYSINH,c.TENPHONG,LEFT(c.TENPHONG,1) as DAY,e.MALOPLT "
            ...
            . "c.ID_PHONG=d.ID_PHONG and e.ID_LOPLT=b.ID_LOP and "
...
//    $workSheet->getColumnDimension('J')->setAutoSize(true);
    ...
    $workSheet->setCellValueByColumnAndRow(1, $tuDong+1, 'Bằng chữ: '. clsData::convert_number_to_words($tongsotien));
    ...
    $name="bangkethutienphongtungaydenngaysinhvienlt.xls";
    //header('Content-Type: application/vnd.ms-excel');
    ...
    echo "</script>";
    echo "<a  href=\"ktx_bangkethutienphong_hockynamhoc_tungaydenngaylt.php\"> Tiep tuc </a>";
}    
