...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $query_kt ="select * from dsphieuthutienphongsinhvien where ID_THUTIENPHONGSINHVIEN=$idthutienphongsinhvien";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.DONGIA,b.ID_SINHVIEN,b.MASV,b.HODEM,b.TEN,c.TENPHONG "
            . "from thutienphongsinhvien a,sinhvien b,phong c,danhsachnoitru d,lopchuyennganh e "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=d.ID_SINHVIEN and d.ID_PHONG=c.ID_PHONG and b.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH and "
            . "a.ID_THUTIENPHONGSINHVIEN='".$idthutienphongsinhvien."'";  
    //echo $query;
    $result=mysqli_query($connect,$query);
    $somautin=  mysqli_num_rows($result);
    
$query_ins ="select a.ID_THUTIENPHONGSINHVIEN,a.ID_SINHVIEN,a.DONGIA,a.NGAYTHU,a.HOCKY,a.NAMHOC,a.NGUOITHU,"
        . " b.MASV,b.HODEM,b.TEN,c.TENPHONG,e.MALOPCHUYENNGANH "
            . "from thutienphongsinhvien a,sinhvien b,phong c,danhsachnoitru d ,lopchuyennganh e "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and a.ID_SINHVIEN=d.ID_SINHVIEN and d.ID_PHONG=c.ID_PHONG and b.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH and "
            . "a.ID_THUTIENPHONGSINHVIEN='".$idthutienphongsinhvien."'";  
    //echo $query;
    ...
    $masv_insert=$row_insert["MASV"];
    $hodem_insert=$row_insert["HODEM"];
    $ten_insert=$row_insert["TEN"];
    $malop_insert=$row_insert["MALOPCHUYENNGANH"];
    $phong_insert=$row_insert["TENPHONG"];
    $query_insert="insert into dsphieuthutienphongsinhvien (ID_THUTIENPHONGSINHVIEN,ID_SINHVIEN,DONGIA,NGAYTHU,NGAYINPHIEU,"
            . "HOCKY,NAMHOC,NGUOITHU,MASV,HODEM,TEN,MALOPCHUYENNGANH,TENPHONG) "
            . "Values($idthutienphongsinhvien,$idlt_insert,$dongia_insert,'$ngaythu_insert','$ngayinphieu',"
            . "'$hocky_insert','$namhoc_insert','$nguoithu_insert','$masv_insert','$hodem_insert','$ten_insert','$malop_insert','$phong_insert')";
...
//        $workSheet->setCellValueByColumnAndRow(3, 9, $row->TEN);
        ...
        $workSheet->setCellValueByColumnAndRow(1,11, number_format($row->DONGIA));
...
//else {
    ...
    echo "</script>";
    echo "<a  href=\"ktx_inphieuthutienphongsinhvien.php\"> Tiep tuc </a>";
//}
