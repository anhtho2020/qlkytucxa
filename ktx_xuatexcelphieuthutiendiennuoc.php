...
//    $workSheet->setCellValueByColumnAndRow(0, 15, 'NGƯỜI THU');
    ...
    $query ="select a.ID_PHONG,b.ID_THUTIENDIENNUOC,b.THANHTIEN,d.ID_SINHVIEN,d.MASV,d.HODEM,d.TEN,e.MALOPCHUYENNGANH from phong a, thutiendiennuoc b,danhsachnoitru c,sinhvien d,lopchuyennganh e where a.ID_PHONG=b.ID_PHONG and a.ID_PHONG=c.ID_PHONG and c.ID_SINHVIEN=d.ID_SINHVIEN and d.ID_LOPCHUYENNGANH=e.ID_LOPCHUYENNGANH and a.ID_PHONG=$idphong and d.MASV='$masv'";  
    //echo $query;
