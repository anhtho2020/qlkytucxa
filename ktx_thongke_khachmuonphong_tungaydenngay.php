...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;       
        $query ="select a.ID_KHACH,a.ID_PHONG,a.NGAYNOITRU,b.MAKHACH,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,c.TENPHONG "
                . "from dskhachnoitru a,khach b, phong c where a.ID_KHACH=b.ID_KHACH and a.ID_PHONG=c.ID_PHONG";
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Thống kê khách mướn phòng từ ngày đến ngày </h2>
                   ...
                   <div class="panel-body">                   		                       
                     ...
                     <?php
                        ...
                        echo "<form name=\"thongkekhachmuonphongtungaydenngay\" action=\"ktx_xuatexcel_thongke_khach_muonphong_tungay_denngay.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                        ...
                        echo "</tr>";
                        echo "<input type=\"submit\" class=\"btn btn-info\" value=\"Xuất ra excel_Thống kê khách mướn phòng từ ngày đến ngày\">";
                        echo "</form>";   
                        echo "</div>"; 
                       ?>
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                                <td width="5%">STT</td>
                                <td width="10%">MÃ KHÁCH</td>
                                <td width="25%">HỌ VÀ TÊN</td>
                                <td width="10%">PHÁI</td>
                                <td width="15%">NGÀY SINH</td>
                                <td width="10%">PHÒNG</td>
                                <td width="15%">NGÀY MƯỚN PHÒNG</td>
                            </tr>
                          </thead>
                          <tbody>
                        <?php
