...
<html lang="en">
  <head>
    ...
    <?php  
        ...
        $totalRows = 0;       
        $query ="select a.ID_DANHSACHTRAPHONG, a.NGAYNOITRU,a.NGAYTRAPHONG,a.ID_SINHVIEN,b.MAHSSV,b.HODEM,"
                . "b.TEN,b.NGAYSINH, d.TENPHONG "
                . "from danhsachtraphong2017 a,dshssv b,"
                . " phong d where a.ID_SINHVIEN=b.ID_DSHSSV and  a.ID_PHONG=d.ID_PHONG";  
        //echo $query;
...
<!--               <div class="row">
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Danh sách học sinh sinh viên trả phòng 2017 </h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <div class="modal-body">
                        <form role="form" action="ktx_xuatexceldanhsachsinhvientraphong2017.php" method="post">                                                   
                            <button type="submit" class="btn btn-info">In danh sách HSSV trả phòng</button>
                        </form>                                               
                        <br>
                        <form role="form" action="ktx_traphong2017.php" method="post">                                                   
