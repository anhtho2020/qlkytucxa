...
<html lang="en">
  <head>
    ...
    <body>
        <script>
            function xoaphieuthutienphongkhach(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thuchienxoaphieuthutienphongkhach.php?iddsphieuthutienphongkhach="+id;
                }
            }
...
//                }
            ...
            function load(){
                ...
                var url="ktx_xoaphieuthutienphongkhach.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
    <?php  
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Xóa phiếu thu tiền phòng khách</h2>
                   ...
                   <div class="form-group"> 
                    <form role="form" action="ktx_xuatexcel_thongke_phieuthutienkhach.php" method="post">                                                   
...
//                        echo "</tr>";
        ...
        $query ="select a.ID_DSPHIEUTHUTIENPHONGKHACH,a.ID_THUTIENPHONGKHACH,a.ID_KHACH,a.SONGAY,a.DONGIA,a.THANHTIEN,"
                . "a.NGAYTHU,a.NGAYINPHIEU,a.NGUOITHU, b.HODEM,b.TEN,b.NGAYSINH,d.TENPHONG from ";
        $query.= "dsphieuthutienphongkhach a,khach b,phong d where ";
        $query.="a.ID_KHACH=b.ID_KHACH and a.ID_PHONG=d.ID_PHONG and "
                . "d.ID_PHONG=$idphong ";
        ...
        $totalRows=mysqli_num_rows($result); 
				...
				//echo "<button class=\"btn btn-primary btn-xs\" onClick=\"inphieuthu('".$row["ID_THUTIENPHONGSINHVIEN"]."')\">In phiếu thu</a></button>";
                                ...
                                {
                                    echo"<td>";
                                        echo "<button class=\"btn btn-danger btn-xs\" onClick=\"xoaphieuthutienphongkhach('".$row["ID_DSPHIEUTHUTIENPHONGKHACH"]."')\">Xóa</a></button>";
                                        //echo "<button class=\"btn btn-primary btn-xs\" onClick=\"inphieuthu('".$row["ID_THUTIENPHONGSINHVIEN"]."')\">In phiếu thu</a></button>";
                                        echo"</td>";
                                }
                                ?>
