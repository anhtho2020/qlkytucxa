        ...
        <script>
            function xoathechap(id){
                if(confirm('Ban co chac xoa khong?')){
                    window.location="thuchienxoathechap2017.php?idthechap="+id;
                }
            }
...
//                }
            ...
            function load(){
                ...
                var url="ktx_danhsachthechap2017.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
        </script>
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Xuất phiếu thu tiền thế chấp 2017 </h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                    echo "<div>"; 
                        echo "<form name=\"danhsachthechap\" action=\"ktx_danhsachthechap2017.php\" method=\"post\">";
                    ...
                    echo "<div>";
                        echo "<form name=\"dsphiethuthechap\" action=\"ktx_danhsachthutienthechap2017.php\" method=\"post\">";
                    ...
                    echo "</div>";
                    echo "<div>";
                        echo "<form name=\"thutienthechap\" action=\"ktx_thechap2017.php\" method=\"post\">";
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            echo "<tbody>";
                            $totalRows = 0;       
                            $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,b.MAHSSV,"
                                    . "b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,d.TENPHONG "
                                    . "from thechap2017 a,dshssv b,phong d "
                                    . "where a.ID_SINHVIEN=b.ID_DSHSSV and "
                                    . "a.ID_PHONG=d.ID_PHONG and"
                                    . " d.ID_PHONG=$idphong";
                                    
                                      // and a.ID_THECHAP NOT IN "
                                    //. "(select ID_THECHAP from dsphieuthuthechap where ID_THECHAP is not null)";//
                                    //echo $query;
