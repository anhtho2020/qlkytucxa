...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $query="select a.ID_LIENTHONG,b.MASV,b.HODEM, b.TEN,b.NGAYSINH,a.NGAYNOITRU,c.TENPHONG "
            . "from dssvltnoitru a, lienthong b, phong c "
            . "where (a.ID_LIENTHONG=b.ID_LIENTHONG) and (a.ID_PHONG=c.ID_PHONG)";
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, ' DANH SÁCH SINH VIÊN LIÊN THÔNG NỘI TRÚ ');
