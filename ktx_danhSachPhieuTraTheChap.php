               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    echo "<div class=\"form-group\">";    
                        echo "<form name=\"xuatdanhsachphiethuthechap\" action=\"ktx_xuatExcelDanhSachPhieuChiTheChap.php\" method=\"post\">";
                        echo "<tr>";
                            echo "<td> Từ ngày: </td>";
                        ...
                        echo "</tr>";
                        echo "<button type=\"submit\" class=\"btn btn-info\"> In danh sách phiếu chi trả thế chấp Từ ngày- Đến ngày</button>";
                        echo "</form>";   
                        echo "</div>"; 
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $query="select a.ID_THECHAP,a.ID_SINHVIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,"
                                    . "a.NAMHOC,a.NGAYTRATHECHAP,b.MASV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH,c.NGAYNOITRU,"
                                    . "d.TENPHONG from dsphieuchithechap a,sinhvien b,danhsachnoitru c,phong d "
