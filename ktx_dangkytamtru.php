    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_dangkytamtru.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
    ...
    echo "function tht(){ "; 
      echo "if(confirm('Thông tin chính xác?')){ "; 
          ...
          //var num = $('#dshp input[type=checkbox]:checked').length;           
           ...
           echo "if(str!=\"\"){ "; 
                echo "document.dangkytamtru.submit();";  
                //echo "alert(str);"; 
...
echo "</script>";
        ...
        for($i=0; $i<$sopt-1; $i++){
            $query="insert into dangkytamtru (ID_SINHVIEN,NGAYTAMTRU,GHICHU ) "
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Học sinh sinh viên đăng ký tạm trú</h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    echo "<tr>";
                        ...
                        echo "<div>"; 
                        echo "<form name=\"dangkytamtru\" action=\"ktx_dangkytamtru.php\" method=\"post\">";
                        echo "<div class=\"form-group\">";
                        echo "<tr>";
                        $now = getdate(); 
                        $ngdangkytamtru=$now["mday"] . '/'. $now["mon"] . '/' . $now["year"];
                            ...
                            echo "<td>&nbsp</td> ";
                            echo "<td width=\"60\"> <input type=\"text\" name=\"ngaydangkytamtru\" id=\"ngaydangkytamtru\" size=\"10\" maxlength=\"10\" value=\"".$ngdangkytamtru."\" </td>";
                        echo "</tr>";
                        echo "<tr>";
                            echo "<td> Ghi chú: </td>";
                       ...
                       if($_SESSION["quyen"]=="QT")
                        ...
                        echo "<div>";
                        echo "<form name=\"danhsachtamtru\" action=\"ktx_danhsachsinhvienoktx_dangkytamtru.php\" method=\"post\">";
                            echo "<button type=\"submit\" class=\"btn btn-info\"> Danh sách tam tru </button>";
                        echo "</form>";
                    echo "</div>";
                    ?>
  		</div>                   
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $totalRows = 0;       
                            $stSQL ="select a.ID_SINHVIEN,a.MASV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,b.NGAYNOITRU,c.MALOPCHUYENNGANH from sinhvien a,"
                                    . "danhsachnoitru b,lopchuyennganh c  where a.ID_SINHVIEN =b.ID_SINHVIEN and b.ID_PHONG=$idphong and a.ID_LOPCHUYENNGANH =c.ID_LOPCHUYENNGANH and "
                                    . "a.ID_SINHVIEN not in (select ID_SINHVIEN from dangkytamtru where ID_SINHVIEN is not null)";// from danhsachnoitru where ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
                            //echo $stSQL;
