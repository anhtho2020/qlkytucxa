...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $query_kt ="select * from dsphieuthuthechap where ID_THECHAP=$idthechap";  //echo $query_kt;
...
//    $workSheet->mergeCells('A13:B13');
    ...
    $query ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPCHUYENNGANH from thechap a, sinhvien b ,lopchuyennganh c "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and a.ID_THECHAP=$idthechap";  
    //echo $query;
    ...
    $query_ins ="select a.ID_THECHAP,a.ID_SINHVIEN,a.SOTIEN,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.NGUOITHU, "
            . "b.MASV,b.HODEM,b.TEN,b.NGAYSINH,b.PHAI,c.MALOPCHUYENNGANH from thechap a, sinhvien b ,lopchuyennganh c "
            . "where a.ID_SINHVIEN=b.ID_SINHVIEN and b.ID_LOPCHUYENNGANH=c.ID_LOPCHUYENNGANH and a.ID_THECHAP=$idthechap";  
    //echo $query_ins;
    ...
    $query_insert="insert into dsphieuthuthechap(ID_THECHAP,ID_SINHVIEN,NGAYTHECHAP,NGAYINPHIEU,SOTIEN,"
            . "HOCKY,NAMHOC,NGUOITHU) "
            . "Values($idthechap,$idlt_insert,'$ngthechap_insert','$ngayinphieu',$sotien_insert,"
...
//    //Thực hiện xóa
//    
//    $query_xoa="delete from thechap where ID_THECHAP='".$idthechap."'";
//    $result_xoa=mysql_query($query_xoa, $connect);
    ...
    echo "</script>";
    echo "<a  href=\"ktx_danhsachthechap.php\"> Tiep tuc </a>";
}
