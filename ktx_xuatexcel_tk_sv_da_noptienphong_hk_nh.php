...
//    $workSheet->getColumnDimension('J')->setAutoSize(true);
    ...
    $workSheet->mergeCells("A".(9+$somautin).":G".(9+$somautin));
    $workSheet->getStyle("A".(9+$somautin).":G".(9+$somautin))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
