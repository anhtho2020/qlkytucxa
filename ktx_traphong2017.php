    ...
    <body>
        <script>
            ...
            function load(){
                ...
                var url="ktx_traphong2017.php?idday="+idday+"&idphong="+idphong;
                window.location=url;
            }
...
echo "</script>";
    ...
    $link=  clsConnet::DBConnect();
        ...
        for($i=0; $i<$sopt-1; $i++){
            $totalRows_ngnt = 0;       
            $query_ngnt ="select * from danhsachnoitrum  where ID_SINHVIEN='$arr[$i]'";
        ...
        $totalRowsIns=0;
        for($i=0; $i<$sopt-1; $i++){
            $qInsert="select MAHSSV,HODEM,TEN from dshssv where ID_DSHSSV='$arr[$i]'";//echo $qInsert;
        ...
        for($i=0; $i<$sopt-1; $i++){
            ...
            $query="insert into danhsachtraphong2017 (ID_SINHVIEN,ID_PHONG,NGAYNOITRU,NGAYTRAPHONG,GHICHU,MASV,HODEM,TEN ) "
                    . "values($arr[$i],$iphong,'$ngaynt[$i]','$ngaytraphong','$ghichu','$masv[$i]','$hodem[$i]','$ten[$i]')";//echo $query;
            mysqli_query($link,$query);
            $query_xoanoitru="delete from danhsachnoitrum where ID_SINHVIEN='".$arr[$i]."'";
          ...
          <section class="wrapper">         
               ...
               <div class="panel panel-default">
                    <header class="panel-heading">
                        <h2> Học sinh sinh viên trả phòng 2017</h2>
                   ...
                   <div class="panel-body">                   		                       
                    ...
                    <?php
                        echo "<div>"; 
                        echo "<form name=\"traphong\" action=\"ktx_traphong2017.php\" method=\"post\">";
                        ...
                        echo "<div class=\"form-group\">";
                        echo "<form role=\"form\" action=\"ktx_danhsachsinhvientraphong2017.php\" method=\"post\">";
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $totalRows = 0;       
                            $stSQL ="select a.ID_DSHSSV,a.MAHSSV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI, b.NGAYNOITRU,c.ID_PHONG from dshssv a,danhsachnoitrum b, phong c where a.ID_DSHSSV =b.ID_SINHVIEN and b.ID_PHONG=c.ID_PHONG and "
