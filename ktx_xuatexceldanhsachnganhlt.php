...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(1, 7, 'MÃ NGÀNH');
    $workSheet->setCellValueByColumnAndRow(2, 7, 'TÊN NGÀNH');
...
//    $workSheet->getColumnDimension('G')->setAutoSize(true);
    ...
    while($row=mysqli_fetch_object($result)){
        ...
        $workSheet->setCellValueByColumnAndRow($tuCot+1, $tuDong, $row->MANGANH);
        $workSheet->setCellValueByColumnAndRow($tuCot+2, $tuDong, $row->TENNGANH);
