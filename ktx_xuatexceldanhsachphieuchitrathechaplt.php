...
//    mysql_query("SET CHARACTER SET utf8",$connect);
    ...
    $workSheet->setCellValueByColumnAndRow(0, 5, 'DANH SÁCH PHIẾU CHI TRẢ TIỀN THẾ CHẤP LT');
...
//    $workSheet->setCellValueByColumnAndRow(2, 7, 'PHÒNG');
    ...
    $query="select a.ID_THECHAPLT,a.ID_LIENTHONG,a.NGAYTHECHAP,a.SOTIEN,a.HOCKY,a.NAMHOC,a.GHICHU,"
            . "a.NGAYTRATHECHAP,b.MASV,b.HODEM,b.TEN,b.PHAI,b.NGAYSINH "
            . "from dsphieuchithechaplt a,lienthong b "
...
//        $workSheet->setCellValueByColumnAndRow($tuCot+2, $tuDong, $row->TENPHONG);
    ...
    $name="dsphieuchitienthechaplt.xls";
    //header('Content-Type: application/vnd.ms-excel');
